...
parser.add_argument('--input_h5_path', type=str, default="data/simulated_balanced/data_0.05c2.h5",#data/original/Human3.h5
...
parser.add_argument('--save_h5ad_dir', type=str, default="./data/simulated_balanced_processed",#./data/processed
                    help='dir to savings')
